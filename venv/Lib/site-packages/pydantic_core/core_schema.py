    ...
    *,
    ...
    Args:
        choices: The schemas to match
            ...
            it should be fed src into the `choices` map until a schema is obtained
...
def typed_dict_schema(
    ...
    *,
    ...
    Args:
        ...
        cls_name: The name to use in error locations. Falls src to `cls.__name__`, or the validator name if no class
            is provided.
