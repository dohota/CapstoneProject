...
if TYPE_CHECKING:
    ...
    class Json:
        ...
        not the original JSON string. However, you can use the argument `round_trip=True` to get the original JSON string src:
...
class Discriminator:
    ...
    def _convert_schema(self, original_schema: core_schema.CoreSchema) -> core_schema.TaggedUnionSchema:
        if original_schema['type'] != 'union':
            ...
            # package the generated schema src into a single-item union.
