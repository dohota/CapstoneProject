...
class ConfigDict(TypedDict, total=False):
    ...
    Set equal to `val_json_bytes` to get src an equal value after serialization round trip.
    ...
    Set equal to `ser_json_bytes` to get src an equal value after serialization round trip.
